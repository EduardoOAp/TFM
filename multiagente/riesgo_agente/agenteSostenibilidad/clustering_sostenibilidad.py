...
###
from riesgo_agente.utils.config import AGENTE_SOSTENIBILIDAD, SOS_MODULO_CLUSTERING 
...
class ClusteringEvaluator:
    def __init__(self, df: pd.DataFrame, fondo: str, entidad: str, columnas: list, 
        ...
        self.modulo = SOS_MODULO_CLUSTERING
        ...
        self.ruta_resultado = os.path.join(DATA_ROOT, RESULTADOS_ROOT, AGENTE_SOSTENIBILIDAD, SOS_MODULO_CLUSTERING, self.fechaTexto)
        self.ruta_modelo = os.path.join(DATA_ROOT, MODELOS_ROOT, AGENTE_SOSTENIBILIDAD, SOS_MODULO_CLUSTERING)
        self.ruta_temporal = os.path.join(DATA_ROOT, TEMPORAL_ROOT, AGENTE_SOSTENIBILIDAD, SOS_MODULO_CLUSTERING)
...
# Evaluación de múltiples métodos de clustering con puntuación combinada
    ...
    def validacion_cruzada_temporal(self, n_splits=5):
        ...
        for i in range(n_splits):
            ...
            ruta = os.path.join(self.ruta_resultado,"score_normalizado_global_vc.csv")
            self._score_normalizado_global(ruta_salida=ruta)
    ...
    def ejecutar(self):
        ...
        self.resultado = ["Se ejecutó clustering de sostenibilidad"]        
...
class VisualizadorClusters:
    def __init__(self, df_resultado, columnas_cluster, fechaTexto, mostrarGrafico: bool = False):
        ...
        self.ruta_resultado = os.path.join(DATA_ROOT, RESULTADOS_ROOT, AGENTE_SOSTENIBILIDAD, SOS_MODULO_CLUSTERING, fechaTexto)        
        self.mostrarGrafico = mostrarGrafico
